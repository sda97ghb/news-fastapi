...
from news_fastapi.application.rest_api.authors.endpoints import router as authors_router
from news_fastapi.application.rest_api.drafts.endpoints import router as drafts_router
from news_fastapi.application.rest_api.news.endpoints import router as news_router
from news_fastapi.utils.exceptions import AuthorizationError, NotFoundError
