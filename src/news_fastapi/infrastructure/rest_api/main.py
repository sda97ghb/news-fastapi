...
from news_fastapi.infrastructure.rest_api.authors.endpoints import (
    router as authors_router,
)
from news_fastapi.infrastructure.rest_api.drafts.endpoints import (
    router as drafts_router,
)
from news_fastapi.infrastructure.rest_api.news.endpoints import router as news_router
